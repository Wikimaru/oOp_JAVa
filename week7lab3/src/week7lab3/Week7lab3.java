...
public class Week7lab3 {
    ...
    public static void main(String[] args) 
    {
        ...
        employee.dateHired = LocalDate.of(1998, Month.FEBRUARY, 1);
        ...
        faculty.salary = 38000;
        faculty.dateHired = LocalDate.of(1998, Month.FEBRUARY, 23);
        faculty.officeHours = 24;
